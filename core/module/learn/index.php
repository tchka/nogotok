...
class Index extends \Kernel\DefaultModule {
	const TPL_DIR = 'module/learn/tpl/';
	...
	public function showIndex() {
		...
		$items = Model::make()->findAllByAttributes( array('active' => 1), array('order' => '`sort` desc') );
		$paginator = new Navigation($this->page, count($items), $this->page_size , '/learn' , '/page');
